    ...
    async function initializeAuth() {
      ...
      try {
        ...
        if (result.error) {
          ...
          setAuth({ initializing: false, user: result.data });
        }
      } catch {
        setAuth({ initializing: false, user: null });
        setToast({ type: 'error', message: 'Tidak dapat terhubung ke server.' });
      }
    }
    initializeAuth();
  }, []);
  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        {auth.user ? (
          <Routes>
            <Route path="/" element={<NotesPage archived={false} notify={notify} />} />
            <Route path="/archives" element={<NotesPage archived notify={notify} />} />
            <Route path="/notes/new" element={<AddPage notify={notify} />} />
            <Route path="/notes/:id" element={<DetailPage notify={notify} />} />
